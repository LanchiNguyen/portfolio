// Precompile the canonical Morsel JSX with the same Babel build the page pins.
const fs=require('fs');
...
let dataJs=fs.readFileSync(P+'/v4/app/data.js','utf8');
...
let bundle='/* canonical Morsel — data.js + Babel-precompiled JSX, source order preserved */\n'+dataJs+'\n';
